...
def compress_video(original_video, crf_value, output_path, encoder_settings=None):
    encode_cmd = [
        'ffmpeg',
        '-i', original_video,
        '-c:v', 'libx264',
...
if __name__ == "__main__":
    ...
    # BITRATE_THRESHOLD is no longer used directly; dynamic bitrate is calculated
